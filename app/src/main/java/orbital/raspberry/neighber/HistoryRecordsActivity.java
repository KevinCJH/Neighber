                        ...
                        public void onClick(DialogInterface dialog, int pos) {
                            switch (pos) {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    Intent i2 = new Intent(HistoryRecordsActivity.this, ViewProfileActivity.class);
                                    i2.putExtra("rpostid", post.getPostid());
                                    startActivity(i2);
                                    break;
                                case 2:
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_logout:
                // to do logout action
                auth.signOut();
                startActivity(new Intent(HistoryRecordsActivity.this, LoginpageActivity.class));
                finish();
                break;
        }
