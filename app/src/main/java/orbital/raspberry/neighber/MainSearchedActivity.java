      ...
      //  searchtxt.setText(searchkey);
        ...
        uDatabase.child(userid).addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
               // Toast.makeText(MainSearchedActivity.this, "Failed to retrieve user data", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_favourite:
                startActivity(new Intent(MainSearchedActivity.this, FavouriteActivity.class));
                break;
            case R.id.action_feedback:
                startActivity(new Intent(MainSearchedActivity.this, FeedbackActivity.class));
                break;
        }
